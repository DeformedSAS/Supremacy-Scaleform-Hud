	...
	var _AddTopRightExtraButtonsToInventory = function()
	{
		if ( !$( '#TopRightExtraButtons' ) )
		{
			...
			_UpdateLoadoutButtonState();
               ...
               var elReqStorageBtn = elTopRightExtraButtons.FindChild("ReqStorageBtn");
              elReqStorageBtn.SetPanelEvent('onactivate', function() {
              GameInterfaceAPI.ConsoleCommand('request_storage_container');
              });
